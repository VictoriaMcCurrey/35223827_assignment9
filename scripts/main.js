...
//getAllPosts from question 1 uses fetch() and returns JSON data
...
async function getComments(postID){
    ...
    const jsonPostData = await response.json();
    myUsers.userPosts = jsonPostData;
    return myUsers.userPosts;
};
...
async function getUser(userID){
    ...
    myUsers.userData = jsonUserData;
    return myUsers.userData;
};
...
async function getTodosForUser(userID){
    ...
    myUsers.toDos = jsonToDos;
    return myUsers.toDos;
};